...
- 保留三层车模层板与四根承托柱；每层为两片 180 mm 宽的可打印层板，以两组榫舌/槽定位，并在底面用一片跨缝加强片胶粘承力。柱由 Z=8 延伸至 Z=230。
- 主体 238 mm 高度不包含独立广告牌。`Lovely Cars I've Driven` 广告牌从 Z=330 至 394 mm；两根支架中心为 X=90 与 X=270 mm，严格对称于广告牌中线 X=180 mm，且下部粘接在背板上。
