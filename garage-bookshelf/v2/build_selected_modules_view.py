...
PROFILES = {
    ...
    "narrow-fixed": (["module_2_narrow_visual", "module_5_narrow_visual"], "modules-2-5-narrow-visual-fixed-x2d-pla.3mf", "modules-2-5-narrow-visual-fixed.json"),
}
...
for index, (object_id, name) in enumerate(objects, 1):
    ...
    entries[f"Metadata/plate_{index}.json"] = json.dumps({
        ...
        "bed_type": "textured_plate", "first_extruder": 1,
        "first_layer_time": 0, "is_seq_print": False,
        "nozzle_diameter": 0.4, "version": 2,
