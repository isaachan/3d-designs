...
const billboard=`<rect x="${x(0)}" y="${z(364)}" width="${360*S}" height="${64*S}" fill="#16181c"/><line x1="${x(90)}" y1="${z(238)}" x2="${x(90)}" y2="${z(300)}" stroke="#16181c" stroke-width="10"/><line x1="${x(270)}" y1="${z(238)}" x2="${x(270)}" y2="${z(300)}" stroke="#16181c" stroke-width="10"/><text x="${x(180)}" y="${z(343)}" text-anchor="middle" font-family="sans-serif" font-size="19" font-weight="bold" fill="white">Lovely Cars</text><text x="${x(180)}" y="${z(315)}" text-anchor="middle" font-family="sans-serif" font-size="19" font-weight="bold" fill="white">I've Driven</text>`;
