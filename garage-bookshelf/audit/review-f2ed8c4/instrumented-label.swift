...
try! bitmap.representation(using: .png, properties: [:])!.write(to: URL(fileURLWithPath: "/Users/kai.han/code/3d-designs/garage-bookshelf/audit/review-f2ed8c4/raw-\(vertical ? "vertical" : "horizontal").png"))
